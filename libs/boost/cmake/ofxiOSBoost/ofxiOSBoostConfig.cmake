...
if(NOT CMAKE_SYSTEM_NAME STREQUAL "iOS")
    message(FATAL_ERROR "ofxiOSBoost 1.90.0 supports iOS targets only")
endif()
...
if(NOT EXISTS "${_OFXIOSBOOST_LIBRARY_PATH}" OR
   NOT IS_DIRECTORY "${_OFXIOSBOOST_INCLUDE_PATH}")
    message(FATAL_ERROR
        "ofxiOSBoost 1.90.0 is incomplete or has no slice for ${CMAKE_OSX_SYSROOT}")
endif()
...
set(ofxiOSBoost_VERSION "1.90.0")
