...
if [[ "$BOOST_VERSION" == "1.76.0" || "$BOOST_VERSION" == "1.77.0" || "$BOOST_VERSION" == "1.78.0" || "$BOOST_VERSION" == "1.79.0" || "$BOOST_VERSION" == "1.80.0" || "$BOOST_VERSION" == "1.81.0" || "$BOOST_VERSION" == "1.82.0" || "$BOOST_VERSION" == "1.83.0" || "$BOOST_VERSION" == "1.84.0" ]]; then
...
if [[ "$BOOST_VERSION" == "1.81.0" || "$BOOST_VERSION" == "1.82.0" || "$BOOST_VERSION" == "1.83.0" || "$BOOST_VERSION" == "1.84.0" ]]; then
    DEFAULT_BOOST_LIBS="$DEFAULT_BOOST_LIBS url log container timer type_erasure stacktrace"
fi
if [[ "$BOOST_VERSION" == "1.84.0" ]]; then
...
case "$BOOST_VERSION" in
    1.61.0|1.62.0|1.63.0|1.64.0|1.65.0|1.66.0|1.67.0|1.68.0|1.69.0|1.70.0|1.71.0|1.72.0|1.73.0|1.74.0|1.75.0|1.76.0|1.77.0|1.78.0|1.79.0|1.80.0|1.81.0|1.82.0|1.83.0|1.84.0) ;;
...
if [[ "$BOOST_VERSION" == "1.83.0" || "$BOOST_VERSION" == "1.84.0" ]]; then
    case "$BOOST_VERSION" in
...
HOST_TOOLSET=cc
if [[ "$BOOST_VERSION" == "1.71.0" || "$BOOST_VERSION" == "1.72.0" || "$BOOST_VERSION" == "1.73.0" || "$BOOST_VERSION" == "1.74.0" || "$BOOST_VERSION" == "1.75.0" || "$BOOST_VERSION" == "1.76.0" || "$BOOST_VERSION" == "1.77.0" || "$BOOST_VERSION" == "1.78.0" || "$BOOST_VERSION" == "1.79.0" || "$BOOST_VERSION" == "1.80.0" || "$BOOST_VERSION" == "1.81.0" || "$BOOST_VERSION" == "1.82.0" || "$BOOST_VERSION" == "1.83.0" || "$BOOST_VERSION" == "1.84.0" ]]; then
    HOST_TOOLSET=clang
fi
(
    cd "$SOURCE_DIR"
...
build_platform() {
    ...
    if [[ "$BOOST_VERSION" == "1.65.0" || "$BOOST_VERSION" == "1.66.0" || "$BOOST_VERSION" == "1.67.0" || "$BOOST_VERSION" == "1.68.0" || "$BOOST_VERSION" == "1.69.0" || "$BOOST_VERSION" == "1.70.0" || "$BOOST_VERSION" == "1.71.0" || "$BOOST_VERSION" == "1.72.0" || "$BOOST_VERSION" == "1.73.0" || "$BOOST_VERSION" == "1.74.0" || "$BOOST_VERSION" == "1.75.0" || "$BOOST_VERSION" == "1.76.0" || "$BOOST_VERSION" == "1.77.0" || "$BOOST_VERSION" == "1.78.0" || "$BOOST_VERSION" == "1.79.0" || "$BOOST_VERSION" == "1.80.0" || "$BOOST_VERSION" == "1.81.0" || "$BOOST_VERSION" == "1.82.0" || "$BOOST_VERSION" == "1.83.0" || "$BOOST_VERSION" == "1.84.0" ]]; then
        local abi=sysv
    ...
    if [[ ( "$BOOST_VERSION" == "1.70.0" || "$BOOST_VERSION" == "1.71.0" || "$BOOST_VERSION" == "1.72.0" || "$BOOST_VERSION" == "1.73.0" || "$BOOST_VERSION" == "1.74.0" || "$BOOST_VERSION" == "1.75.0" || "$BOOST_VERSION" == "1.76.0" || "$BOOST_VERSION" == "1.77.0" || "$BOOST_VERSION" == "1.78.0" || "$BOOST_VERSION" == "1.79.0" || "$BOOST_VERSION" == "1.80.0" || "$BOOST_VERSION" == "1.81.0" || "$BOOST_VERSION" == "1.82.0" || "$BOOST_VERSION" == "1.83.0" || "$BOOST_VERSION" == "1.84.0" ) && " $BOOST_LIBS " == *" locale "* ]]; then
